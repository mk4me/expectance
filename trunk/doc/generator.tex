...
\textbf{
\begin{flushleft} \small
if (Config::getInstance()->IsKey("DEBUG\_CONTROL"))
CONTROL = Config::getInstance()->GetIntVal("DEBUG\_CONTROL");
\end{flushleft}
}
\end{enumerate}
	
Teraz gdy ustawimy w pliku application.cfg wpis np. \textit{DEBUG\_CONTROL = 2} to poziom debugow \textit{CONTROL} zostanie ustawiony na 2.
