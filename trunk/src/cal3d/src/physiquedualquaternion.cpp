...
#include "cal3d/src/dualquaternion.h"
...
int CalPhysiqueDualQuat::calculateVertices(CalSubmesh *pSubmesh, float *pVertexBuffer, int stride)
{
	if (stride <= 0)
	{
...
int CalPhysiqueDualQuat::calculateNormals(CalSubmesh *pSubmesh, float *pNormalBuffer, int stride)
{
	if(stride <= 0)
	{
		stride = 3*sizeof(float);
...
int CalPhysiqueDualQuat::calculateVerticesAndNormals(CalSubmesh *pSubmesh, float *pVertexBuffer, int stride)
{
	if(stride <= 0)
	{
