...
public:
	...
	friend Quat slerp(const Quat &q1, const Quat &q2, float t);
};
...
//std::ostream &operator<<(std::ostream &os, const Piavca::Quat &q);
//std::istream &operator>>(std::istream &is, Piavca::Quat &q);
